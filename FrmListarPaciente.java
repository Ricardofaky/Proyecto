package visual;
import control.AdmAmbulancias;

public class FrmListarPaciente extends javax.swing.JDialog {

    private AdmAmbulancias admBebe=AdmAmbulancias.getAdmBebe();
    
    public FrmListarPaciente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

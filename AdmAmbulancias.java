...
public class AdmAmbulancias {
    private static AdmAmbulancias AdmB=null;
    
    private ArrayList <Paciente> listas=new ArrayList<Paciente>();
    private Paciente b=null;
    
    public static AdmAmbulancias getAdmBebe() {
        if(AdmB==null)
            AdmB=new AdmAmbulancias();
        return AdmB;
    }

    public AdmAmbulancias() {
        listas=new ArrayList<Paciente>();
    }
    
    public ArrayList<Paciente> getListas() {
        return listas;
    }
    public void setListas(ArrayList<Paciente> listas) {
        this.listas = listas;
    }
    ...
    private void llenarFila(JTable tblBebe, int fila, Paciente bb) {
    ...
    public String guardarEdicion(int posicion, String cedula, String nombre, String sexo, String fecha, String peso, 
        ...
        b=new Paciente(cedula, nombre, sexo.charAt(0), fecha, Double.parseDouble(peso), Double.parseDouble(estatura),

...
public class FrmMenuPaciente extends javax.swing.JFrame {
    ...
    private AdmAmbulancias admB = AdmAmbulancias.getAdmBebe();

    public FrmMenuPaciente() {
        initComponents();
    }

    FrmMenuPaciente(FrmNuevoPaciente aThis, boolean b) { }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("SISTEMA DE GESTIÓN DE AMBULANCIAS");
        ...
        jLabel6.setText("REDISEÑO - Materia: GCS");
        jLabel6.setToolTipText("");

        mniMenu.setText("Menú");

        mniRegistrar.setText("Registrar Paciente");
    ...
    private void mniRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniRegistrarActionPerformed
        FrmNuevoPaciente frm = new FrmNuevoPaciente(this, true);
        frm.setVisible(true);
    ...
    private void mniListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniListarActionPerformed
        FrmListarPaciente frm = new FrmListarPaciente(this, true);
    ...
    private void mniEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniEditarActionPerformed
        FrmEditarPaciente frm = new FrmEditarPaciente(this, true);
        if(admB.getListas().size()>0)
            frm.setVisible(true);
        else
